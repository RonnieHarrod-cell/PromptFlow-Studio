...
const VERSION =
  envVersion && /^\d/.test(envVersion) ? envVersion : APP_VERSION_FALLBACK;
const BUILD_DATE = "16/04/2026";
    ...
    variants: [
      {
        ...
        recommended: true,
        filename: `PromptFlow-${VERSION}-x64.dmg`,
      },
      {
        label: "arm64 .dmg",
        arch: "arm64",
        ext: "dmg",
        size: "132 MB",
        chip: "aarch64 Macs (M1-M4)",
        filename: `PromptFlow-${VERSION}-arm64.dmg`,
      },
    ],
  },
];
...
const CHECKSUMS = [
  {
    file: `PromptFlow-Setup-${VERSION}-x64.exe`,
    sha: "sha256:d2386595afa306151c96baa45ea035126eeab9bc381e79daf842e386d6b8e1df",
  },
  {
    file: `PromptFlow-Setup-${VERSION}-arm64.exe`,
    sha: "sha256:d7e97e1730cdb3bf6f42377b683f30074d86bf6f7779cfcfa05b439c554751d3",
  },
  {
    file: `PromptFlow-Setup-${VERSION}-ia32.exe`,
    sha: "sha256:31cbc135fc9da07e76b1bec8f41910638b5d8494c373a9aaa3914a5090b593f4",
  },
  {
    file: `PromptFlow-${VERSION}-x86_64.AppImage`,
    sha: "sha256:4e12f67a03f89f02ed15a6cf4704c53e4c0a338b4174d9ab13f180bbf641adda",
  },
  {
    file: `PromptFlow-${VERSION}-x86_64.deb`,
    sha: "sha256:3acd312ba18757d342f6f55bdb98dd50ba54faeace497b6470cf5aa62c08ceee",
  },
  {
    file: `PromptFlow-${VERSION}-x86_64.rpm`,
    sha: "sha256:502c26e5c6f9ab002c66c1470ac44a4a9ca94858b22b4c284ee28374fe02a24e",
  },
  {
    file: `PromptFlow-${VERSION}-arm64.AppImage`,
    sha: "sha256:9c6924449c280212ac59adfcdb7b13dd640dd7a39a9090faa2dc64f322cd804c",
  },
  {
    file: `PromptFlow-${VERSION}-arm64.deb`,
    sha: "sha256:55d6342b4e00769d9c041d19ca161b1dfbac21fcadae355bcb24bb7eb4c4dbbd",
  },
  {
    file: `PromptFlow-${VERSION}-x64.dmg`,
    sha: "sha256:1c3e7b8a9c8e5c3d9f1e5b2a4c6d8e9f0a1b2c3d4e5f67890abcdef1234567890ab",
  },
  {
    file: `PromptFlow-${VERSION}-arm64.dmg`,
    sha: "sha256:abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcd",
  },
];
...
function DownloadCard({ variant }) {
  ...
  return (
    <div
      className={`${styles.card} ${variant.recommended ? styles.recommended : ""}`}
    >
    ...
    <div className={styles.page}>
      ...
      <div className={styles.hero}>
        <div className={styles.eyebrow}>
          <span className={styles.ring} aria-hidden="true" />v{VERSION} · Build{" "}
          {BUILD_DATE}
        </div>
      ...
      {RELEASES.map((rel) => (
        <section key={rel.os} className={styles.osSection}>
          <div className={styles.osHeader}>
            ...
            <div>
              <h2 className={styles.osName} style={{ "--c": rel.color }}>
                {rel.os}
              </h2>
              <span className={styles.osCount}>
                {rel.variants.length} build{rel.variants.length > 1 ? "s" : ""}{" "}
                available
              </span>
            </div>
          </div>
      ...
      <button className={styles.prevReleasesBtn}>
        <a
          href="https://github.com/RonnieHarrod-cell/PromptFlow-Desktop/releases"
          target="_blank"
          rel="noopener noreferrer"
          className={styles.prevReleasesBtnLink}
        >
          Previous Releases
        </a>
      </button>
      ...
      <p className={styles.footerNote}>
        ...
        available for teams navigating at scale.
      </p>
    </div>
  );
}
